package com.meneguim.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.meneguim.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				"Esta API é utilizada no curso de Spring Boot", "Versão 1.0",
				"",
				new Contact("Alan Meneguim", "", "alan.meneguim@gmail.com"),
				"Permitido uso para estudantes", "", Collections.emptyList() // Vendor Extensions
		);
	}
