...
import com.meneguim.cursomc.dto.ClienteDTO;
import com.meneguim.cursomc.dto.ClienteNewDTO;
...
public class ClienteService {
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		String fineName = prefix + user.getId() + ".jpg";
		
		return s3Service.uploadFile(imageService.getInputStream(jpgImage, "jpg"), fineName, "image");
	}
}
