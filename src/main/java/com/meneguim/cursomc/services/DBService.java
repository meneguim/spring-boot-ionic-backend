...
import com.meneguim.cursomc.domain.Endereco;
import com.meneguim.cursomc.domain.Estado;
import com.meneguim.cursomc.domain.ItemPedido;
import com.meneguim.cursomc.domain.Pagamento;
import com.meneguim.cursomc.domain.PagamentoComBoleto;
import com.meneguim.cursomc.domain.PagamentoComCartao;
import com.meneguim.cursomc.domain.Pedido;
import com.meneguim.cursomc.domain.Produto;
import com.meneguim.cursomc.domain.enums.EstadoPagamento;
import com.meneguim.cursomc.domain.enums.Perfil;
import com.meneguim.cursomc.domain.enums.TipoCliente;
...
import com.meneguim.cursomc.repositories.EnderecoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12, p13, p14, p15, p16, p17, p18, p19, p20,
												p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, 
		...
		Cliente cli1 = new Cliente( null, "Maria Silva", "alan.meneguim@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente( null, "Ana Costa", "meneguim@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27360000","93830000"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "23477012", cli2, c2);
